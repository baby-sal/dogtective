...
def dog_image(pos_x,pos_y):
    smol_dog_pic = pygame.image.load(
        "../logic/assets/images/characters/dogtective_sprite/Walk.png").convert_alpha()
...
def credit_screen():
    while True:
        ...
        display.fill("pink")
        bg = pygame.transform.smoothscale((pygame.image.load("../logic/assets/images/menu/urban-landscape-background-Preview.png").convert()), display.get_size())
        display.blit(bg, (0, 0))
